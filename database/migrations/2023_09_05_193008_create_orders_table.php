...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('tbl_order', function (Blueprint $table) {
            ...
            $table->integer('edit_status')->default(0)->comment('0=not edited 1=edited');
            $table->integer('edit_confirm')->default(0)->comment('0=not approved 1=approved');
            ...
            $table->integer('return_status')->default(0)->comment('0=pending 1=accepted/processing 2=rejected 3=verified 4=picked');
            ...
            $table->string('offer_total', 10)->nullable();
