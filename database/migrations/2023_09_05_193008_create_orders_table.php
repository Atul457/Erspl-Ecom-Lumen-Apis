...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('order', function (Blueprint $table) {
            ...
            $table->integer("edit_status")->nullable()->default(0)->comment("0=not edited 1=edited");
            $table->integer("edit_confirm")->nullable()->default(0)->comment("0=not approved 1=approved");
